...
public class ConfigureSwaggerOptions : IConfigureOptions<SwaggerGenOptions>
{
    ...
    public void Configure(SwaggerGenOptions options)
    {
        ...
        foreach (ApiVersionDescription description in provider.ApiVersionDescriptions) options.SwaggerDoc(description.GroupName, CreateInfoForApiVersion(description));
    }
    ...
    private static OpenApiInfo CreateInfoForApiVersion(ApiVersionDescription description)
    {
        ...
        OpenApiInfo info = new()
        {
            ...
            Contact = new OpenApiContact { Name = "Emre Hızlı", Email = "hizliemre@gmail.com" },
